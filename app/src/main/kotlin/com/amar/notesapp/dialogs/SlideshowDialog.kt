...
import com.amar.NoteDirector.helpers.SLIDESHOW_DEFAULT_INTERVAL
...
class SlideshowDialog(val activity: SimpleActivity, val callback: () -> Unit) {
    ...
    init {
        view = LayoutInflater.from(activity).inflate(com.amar.NoteDirector.R.layout.dialog_slideshow, null).apply {
        ...
        AlertDialog.Builder(activity)
            ...
            getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener({
                if (!view.include_photos.isChecked && !view.include_videos.isChecked && !view.include_gifs.isChecked) {
                    activity.toast(com.amar.NoteDirector.R.string.no_media_for_slideshow)
